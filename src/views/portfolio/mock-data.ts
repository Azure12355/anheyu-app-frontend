...
export const mockPortfolios: Portfolio[] = [
  // 前端项目
  {
    ...
    description:
      "An immersive 3D digital gallery crafted to push the boundaries of WebGL. Ethereal allows users to navigate a curated collection of contemporary neural artworks in a seamless, fluid virtual environment.",
    cover_url:
    ...
    overview:
      "Ethereal is not just a website; it's a spatial computing experiment for the browser. By blending architectural brutalism with fluid, generative data-visualizations, we created a gallery space that feels boundless, yet precisely engineered.",
    role: "Lead Front-end & Creative Developer",
    duration: "4 Months (2024)",
    client: "Studio Neural & Co.",
    challenge:
      "The primary challenge was maintaining an uncompromising 60fps frame rate while rendering hundreds of high-resolution textures, volumetric lighting, and complex post-processing bloom effects in a mobile browser environment. We also had to design an intuitive navigation system for an unconventional 3D space.",
    solution:
  ...
  },
  {
    ...
    title: "React 18 电商平台",
    description:
      "使用 React 18 + Next.js 14 构建的全栈电商解决方案，包含商品管理、购物车、订单系统等核心功能。",
    cover_url:
      "https://images.unsplash.com/photo-1472851294608-415522f96319?w=800&q=80",
    project_type: ProjectType.FRONTEND,
    status: ProjectStatus.COMPLETED,
  ...
  },
  {
    ...
    description:
      "基于 WebGL 的 3D 产品展示展厅，支持模型加载、材质编辑、灯光效果等，提供沉浸式浏览体验。",
    cover_url:
  ...
  },
  {
    ...
    description:
      "支持 SSR 渲染的个人博客系统，优化 SEO，提供 Markdown 编辑、代码高亮、评论系统等功能。",
    cover_url:
      "https://images.unsplash.com/photo-1499750310159-5420f763a887?w=800&q=80",
    project_type: ProjectType.FRONTEND,
    status: ProjectStatus.COMPLETED,
  ...
  },
  {
    ...
    title: "Angular 组件库",
    description:
      "企业级 Angular 组件库，包含 50+ 高质量组件，支持主题定制、按需加载、国际化等功能。",
    cover_url:
  ...
  // VibeCoding 项目
  {
    ...
    title: "AI 代码助手",
    description:
      "基于大语言模型的智能代码补全工具，支持多种编程语言，提供代码解释、重构建议等功能。",
    cover_url:
  ...
  },
  {
    ...
    title: "代码审查机器人",
    description:
      "自动化代码审查工具，集成 ESLint、Prettier，支持 Git Hook，提供代码质量报告和改进建议。",
    cover_url:
  ...
  },
  {
    ...
    title: "智能部署平台",
    description:
      "一键部署工具，支持多种云服务商，提供 CI/CD 流程、环境配置、日志监控等功能。",
    cover_url:
  ...
  // 全栈项目
  {
    ...
    title: "在线协作白板",
    description:
      "实时协作白板应用，支持多人同时绘图、文字输入、文件共享，使用 WebSocket 实现实时同步。",
    cover_url:
  ...
  },
  {
    ...
    title: "任务管理系统",
    description:
      "企业级任务管理平台，包含项目管理、任务分配、进度跟踪、团队协作等功能。",
    cover_url:
  ...
  },
  {
    ...
    title: "即时通讯应用",
    description:
      "支持文字、语音、视频聊天的即时通讯应用，端到端加密，支持群组、文件传输等功能。",
    cover_url:
  ...
  },
  {
    ...
    title: "在线编程教育平台",
    description:
      "提供编程课程、在线编程练习、代码评审等功能的综合教育平台，支持多种编程语言。",
    cover_url:
  ...
  // 小程序
  {
    ...
    title: "点餐小程序",
    description:
      "微信小程序点餐系统，支持菜单展示、在线下单、支付、订单跟踪等功能。",
    cover_url:
  ...
  },
  {
    ...
    title: "电商购物小程序",
    description:
      "完整的电商购物小程序，包含商品展示、购物车、订单管理、优惠券等功能。",
    cover_url:
  ...
  },
  {
    ...
    title: "社区服务小程序",
    description:
      "社区便民服务小程序，包含物业缴费、报修、社区公告、二手交易等功能。",
    cover_url:
  ...
  },
  {
    ...
    title: "健身打卡小程序",
    description:
      "健身运动打卡小程序，支持运动记录、数据统计、社交分享、成就系统等功能。",
    cover_url:
  ...
  // APP
  {
    ...
    title: "跨平台任务管理 APP",
    description:
      "使用 Flutter 开发的跨平台任务管理应用，支持 iOS 和 Android，提供离线同步、推送通知等功能。",
    cover_url:
  ...
  },
  {
    ...
    title: "音乐播放器 APP",
    description:
      "Android 音乐播放器，支持本地音乐、在线音乐、歌词显示、均衡器等功能。",
    cover_url:
  ...
  },
  {
    ...
    title: "智能家居控制 APP",
    description:
      "智能家居控制中心，支持设备管理、场景自动化、语音控制、远程监控等功能。",
    cover_url:
  ...
  },
  {
    ...
    title: "记账理财 APP",
    description:
      "个人理财记账应用，支持收支记录、分类统计、预算管理、数据导出等功能。",
    cover_url:
  ...
  // 其他
  {
    ...
    title: "游戏辅助工具集",
    description:
      "多款游戏辅助工具的合集，包括 DPS 计算器、地图标记、团队管理等实用功能。",
    cover_url:
  ...
  },
  {
    ...
    title: "命令行工具集",
    description:
      "提升开发效率的命令行工具集，包含文件处理、代码生成、部署脚本等工具。",
    cover_url:
  ...
  },
  {
    ...
    title: "浏览器插件合集",
    description:
      "提升浏览器使用体验的插件合集，包括广告拦截、密码管理、截图工具等。",
    cover_url:
  ...
  },
  {
    ...
    title: "自动化测试框架",
    description:
      "基于 Playwright 的端到端自动化测试框架，支持视觉回归测试、API 测试、性能测试。",
    cover_url:
  ...
  // 更多前端项目
  {
    ...
    description:
      "使用 SvelteKit 构建的高性能个人网站，极致优化首屏加载速度和 SEO。",
    cover_url:
  ...
  },
  {
    ...
    title: "SolidJS 组件库",
    description:
      "超高性能的 SolidJS 组件库，专为响应式应用设计，提供细粒度响应式更新。",
    cover_url:
...
export const mockStats: PortfolioStats = {
  total: 26,
  byType: {
    [ProjectType.FRONTEND]: 5,
    [ProjectType.VIBE_CODING]: 2,
    [ProjectType.FULL_STACK]: 3,
    [ProjectType.MINIPROGRAM]: 3,
    [ProjectType.APP]: 3,
    [ProjectType.OTHER]: 2,
    [ProjectType.UIUX]: 2,
    [ProjectType.BACKEND]: 2,
    [ProjectType.DEVOPS]: 1,
    [ProjectType.GAME]: 2,
    [ProjectType.MODEL_3D]: 1,
    [ProjectType.ILLUSTRATION]: 0
  },
  byStatus: {
...
export const mockGetPortfolios = async (params?: {
  ...
  let filteredList = mockPortfolios.map(p => ({
    ...
    mode:
      p.mode ||
      ((parseInt(p.id) % 2 === 0 ? "dark" : "light") as "light" | "dark")
  }));
  ...
  if (params?.language && params.language !== "all") {
    filteredList = filteredList.filter(p =>
      p.technologies.some(
        t => t.toLowerCase() === params.language!.toLowerCase()
      )
    );
  }
...
export const mockGetPortfolioById = async (id: string) => {
  ...
  if (portfolio) {
    ...
    const pWithMode = {
      ...
      mode:
        portfolio.mode ||
        ((parseInt(portfolio.id) % 2 === 0 ? "dark" : "light") as
          | "light"
          | "dark")
    };
    return {
